...
HEAP_MANAGER_INIT .proc
    ...
    SET_HEAP_MANAGER_BLOCK_HEADER PREV_BLOCK_HEADER
    SET_HEAP_MANAGER_BLOCK_HEADER NEXT_BLOCK_HEADER
    SET_HEAP_MANAGER_BLOCK_HEADER REFERENCE_COUNT
    ...
    GET_HEAP_MANAGER_HEADER HEAP_TOTAL_SIZE
    ; LDY #HEAP_MANAGER_HEADER.HEAP_TOTAL_SIZE
    ; LDA [ZP_HEAP_MANAGER_HEADER_POINTER], Y
    ...
    SET_HEAP_MANAGER_BLOCK_HEADER DATA_SIZE
